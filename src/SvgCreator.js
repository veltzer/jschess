...
SvgCreator.createPiece=function(config,pieceColor,pieceType) {
	...
	if(pieceColor.isWhite()) {
		...
		if(pieceType.isRook()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M 11,14 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,14',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 34,14 L 31,17 L 14,17 L 11,14',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 31,17 L 31,29.5 L 14,29.5 L 14,17',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5',stdatt));
		...
		if(pieceType.isBishop()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M 25 8 A 2.5 2.5 0 1 1 20,8 A 2.5 2.5 0 1 1 25 8 z',stdatt));
		...
		if(pieceType.isQueen()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M 9,26 C 17.5,24.5 30,24.5 36,26 L 38,14 L 31,25 L 31,11 L 25.5,24.5 L 22.5,9.5 L 19.5,24.5 L 14,10.5 L 14,25 L 7,14 L 9,26 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10.5,36 C 9,37.5 11,38.5 11,38.5 C 17.5,39.5 27.5,39.5 34,38.5 C 34,38.5 35.5,37.5 34,36 C 34,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26 C 27.5,24.5 17.5,24.5 9,26 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11.5,30 C 15,29 30,29 33.5,30',stdatt));
		...
		if(pieceType.isKing()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 19,16 9.5,13 6.5,19.5 C 3.5,25.5 11.5,29.5 11.5,29.5 L 11.5,37 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11.5,30 C 17,27 27,27 32.5,30',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11.5,33.5 C 17,30.5 27,30.5 32.5,33.5',stdatt));
	...
	if(pieceColor.isBlack()) {
		...
		if(pieceType.isRook()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M 12,36 L 12,32 L 33,32 L 33,36 L 12,36 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 14,29.5 L 14,16.5 L 31,16.5 L 31,29.5 L 14,29.5 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 14,16.5 L 11,14 L 34,14 L 31,16.5 L 14,16.5 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11,14 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,14 L 11,14 z',stdatt));
			stdatt=Utils.clone(stdatt);
			stdatt['stroke']='#fff';
			pieceDesc.add(new SvgPathAndAttributes('M 12,35.5 L 33,35.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 13,31.5 L 32,31.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 14,29.5 L 31,29.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 14,16.5 L 31,16.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11,14 L 34,14',stdatt));
			return pieceDesc;
		}
		if(pieceType.isKnight()) {
		...
		if(pieceType.isQueen()) {
			...
			pieceDesc.add(new SvgPathAndAttributes('M16,8.5C16,10.039600717839003,14.333333333333332,11.001851166488377,13,10.232050807568877C12.381197846482994,9.874785217660714,12,9.214531179816328,12,8.5C12,6.9603992821609975,13.666666666666668,5.998148833511623,15,6.767949192431123C15.618802153517006,7.125214782339286,16,7.785468820183672,16,8.5C16,8.5,16,8.5,16,8.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M33,9C33,10.539600717839003,31.333333333333332,11.501851166488377,30,10.732050807568877C29.381197846482994,10.374785217660714,29,9.714531179816328,29,9C29,7.4603992821609975,30.666666666666668,6.498148833511623,32,7.267949192431123C32.61880215351701,7.625214782339286,33,8.285468820183672,33,9C33,9,33,9,33,9',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10.5,36 C 9,37.5 11,38.5 11,38.5 C 17.5,39.5 27.5,39.5 34,38.5 C 34,38.5 35.5,37.5 34,36 C 34,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26 C 27.5,24.5 17.5,24.5 9,26 z',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11,38.5 A 35,35 1 0 0 34,38.5',stdatt));
			stdatt=Utils.clone(stdatt);
			stdatt['stroke']='#fff';
			pieceDesc.add(new SvgPathAndAttributes('M 11,29 A 35,35 1 0 1 34,29',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 12.5,31.5 L 32.5,31.5',stdatt));
			pieceDesc.add(new SvgPathAndAttributes('M 11.5,34.5 A 35,35 1 0 0 33.5,34.5',stdatt));
