...
<html>
	<head>
		...
		<meta name="Keywords" content="${config.personal.personal_fullname}, ${tdefs.personal_slug}, ${config.project.project_name}, ${', '.join(tdefs.project_keywords)}"/>
	...
	<body>
		...
		<p>The current version of <b>${config.project.project_name}</b> is ${tdefs.git_lasttag}
		</p>
		<p>
