...
# chess
curl https://cdnjs.cloudflare.com/ajax/libs/chess.js/0.10.2/chess.js -o $TP/chess.js 2> /dev/null
#~/install/closure/closure.jar $TP/chess.js --js_output_file $TP/chess.min.js
~/install/jsmin/jsmin < $TP/chess.js > $TP/chess.min.js
